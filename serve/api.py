...
class Item(BaseModel):
    ...
    # 数据库路径
    db_path : str = "/Users/liubo/Documents/KnowHub/personalHub/vector_db/chroma"
    # 源文件路径
    file_path : str = "/Users/liubo/Documents/KnowHub/personalHub/knowledge_db"
    # prompt template
